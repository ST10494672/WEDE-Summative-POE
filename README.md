...
Grace & Grounds Coffeehouse is a faith-centered café in Cape Town, founded by Sarah and Mark Johnson in 2023. The café provides a welcoming space where guests can enjoy quality coffee, connect with others, and experience God’s grace through hospitality, prayer, and community events.

This second phase of the website project refactors the site to use a single external CSS stylesheet. The update improves styling consistency, maintainability, and responsiveness across all devices, while keeping the original mission and structure intact.
